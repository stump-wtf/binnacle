defmodule Binnacle.Fleet.Unifi.ClientTest do
  ...
  describe "fetch_sites/3" do
    test "decodes a valid sites response via plug mock" do
      ...
      assert {:ok, sites} =
               Client.fetch_sites("https://unifi.example.com", "test-key", plug: plug)
    ...
    test "returns error on non-200 status" do
      ...
      assert {:error, reason} =
               Client.fetch_sites("https://unifi.example.com", "bad-key", plug: plug)
    ...
    test "returns error on unreachable host" do
      ...
      assert {:error, reason} =
               Client.fetch_sites("https://unreachable.example.com", "key", plug: plug)
